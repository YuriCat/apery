...
static inline u32 reverseBits(u32 v)noexcept{
    v = (v >> 16) | (v << 16);
...
static inline u64 reverseBits(u64 v)noexcept{
    v = (v >> 32) | (v << 32);
...
static inline Bitboard inverse(Bitboard bb){
    u64 b0 = bb.p(0);
    u32 b1 = u32(bb.p(1));
...
static inline Bitboard inverseIfWhite(Color c, Bitboard bb){
